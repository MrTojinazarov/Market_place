    ...
    <table class="table mt-3">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <button class="btn btn-warning" data-toggle="modal" data-target="#editModal{{ $product->id }}">Edit</button>
                        ...
                        <form action="{{ route('product.update', $product->id) }}" method="POST">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="base_price" name="base_price" value="{{ $product->base_price }}" required>
                                </div>
                            </div>
